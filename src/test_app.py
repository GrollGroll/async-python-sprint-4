...
def test_handle_get_short_url():
    test_url = 'http://example.com'
    request_url = f'{app.url_path_for('handle_get_short_url')}?url={test_url}'
...
#     time.sleep(1)
#     test_id = '-YVX8iA'
#     response = client.get(app.url_path_for('handle_get_original_url', url_id=test_id))
#     assert response.status_code == 307 or 404

# def test_get_status():
#     time.sleep(1)
#     test_id = "saddw"
#     response = client.get(app.url_path_for('handle_get_status', url_id=test_id))
...
#             ]
#         }
#     response = client.post(app.url_path_for('handle_batch_upload_url'), json=test_json)
#     assert response.status_code == 201
